...
<?
	...
	//      $upload_image->image_ratio_y        = true; // ให้คำณวนความสูงอัตโนมัติ
			...
			if ( $upload_image->processed ) {
				...
				$insertSQL = sprintf("INSERT INTO banner (name,path) VALUES ( '%s','%s' )", $image_name, "images/banner/".$image_name );
...
<head>
	...
	<script src="../public/scripts/jquery-1.6.js" type="text/javascript"></script>
	
	<!-- tinyscrollbar -->
	<script type="text/javascript" src="../public/scripts/jquery.tinyscrollbar.min.js"></script>
