	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
		...
		//      $upload_image->image_ratio_y        = true; // ให้คำณวนความสูงอัตโนมัติ
				...
				if ( $upload_image->processed ) {
					...
					$insertSQL = sprintf("INSERT INTO color (Name_EN,Name_TH,path) VALUES ( '%s','%s','%s' )", $nameEn, $nameTh,    "images/color/".$image_name );
			...
			{
				$insertSQL = sprintf("INSERT INTO color (Name_EN,Name_TH) VALUES ( '%s','%s' )", $nameEn, $nameTh);
		...
		<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
			<table>
				...
				<tr style="height:30px;">
					...
					<td style="width:15px;"><img src="../images/dot.gif" /></td>
					<td><input type='text' name='ColorEn'></td>
				</tr>
				<tr style="height:30px;">
					<td style="width:70px;">Color [Th]</td>
					<td style="width:15px;"><img src="../images/dot.gif" /></td>
					<td><input type='text' name='ColorTh'></td>
				</tr>
			</table>
