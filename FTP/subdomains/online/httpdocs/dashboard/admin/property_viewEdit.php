...
<script type="text/javascript" src="editor/ed.js"></script>
	...
	<script src="ajax/ajax.property.java"></script>
</head>
...
<?
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmEditProperty")) 
	{
		...
		$strSQL = "UPDATE property SET name_th = '$Name_TH', name_en = '$Name_EN'
					...
					<div class="viewport">
						<div class="overview">
							<h2>Edit Property</h2>
						 	...
						 	<form action="" method="post" enctype="multipart/form-data" name="frmEditProperty" id="frmEditProperty">
								<table>
									<tbody>
								...
								<input type="hidden" name="MM_insert" value="frmEditProperty" />
								<input type="button" value="Cancel" style="width:60px;" onclick="window.location.href='property.php'">
							</form>	
							<br><br>
							<div id="line"></div>
