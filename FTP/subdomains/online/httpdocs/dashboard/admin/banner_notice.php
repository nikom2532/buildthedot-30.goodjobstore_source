...
<?
	...
	//      $upload_image->image_ratio_y        = true; // ให้คำณวนความสูงอัตโนมัติ
			...
			if ( $upload_image->processed ) {
				...
				$insertSQL = sprintf("INSERT INTO banner_notice (name,path) VALUES ( '%s','%s' )", $image_name, "images/banner/".$image_name );
...
<head>
	...
	<script src="ajax/ajax.banner_notice.java"></script>
</head>
<body>
	<script>
		viewTable();
...
<!------------------------- Upload Image (form) ----------------->
		...
		<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
		  <p><b>Add Notification Banner</b><br><br><br> 
		  <table>
				<tr>
