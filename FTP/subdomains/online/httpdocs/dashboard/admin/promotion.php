...
<?
	...
	//      $upload_image->image_ratio_y        = true; // ให้คำณวนความสูงอัตโนมัติ
			...
			$upload_image->process( "../../public/images/" ); // เก็บภาพไว้ในโฟลเดอร์ที่ต้องการ  *** โฟลเดอร์ต้องมี permission 0777
			...
			if ( $upload_image->processed ) {
				...
				$insertSQL = sprintf("INSERT INTO promotions (name_en,path) VALUES ( '%s','%s' )", $image_name, "images/".$image_name );
...
<head>
	...
	<script src="ajax/ajax.promotion.java"></script>
</head>
<body>
	<script>
		viewTable();
