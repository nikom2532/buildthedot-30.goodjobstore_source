					...
					<div class="viewport">
						<div class="overview">
							...
							<div style="width: 800px; height: 350px; overflow: auto; padding: 5px">
						 	...
						 	<form action="" method="post" enctype="multipart/form-data" name="frmAddProperty" id="frmAddProperty">
								<table>
									<tbody>
										<tr style="height:30px;">
											<td style="width:150px;">Property [En]</td>
											<td style="width:15px;"><img src="../images/dot.gif" /></td>
											<td style="width:300px;"><input type='text' name='Prop_En'></td>
										</tr>
										<tr style="height:30px;">
											<td>Property [Th]</td>
											<td><img src="../images/dot.gif" /></td>
											<td><input type='text' name='Prop_Th'></td>
										</tr>
									</tbody>
								</table>
								<br><br>
								<input type='submit' value='Add' style="width:60px"><br>
								<input type="hidden" name="MM_insert" value="frmAddProperty" />
