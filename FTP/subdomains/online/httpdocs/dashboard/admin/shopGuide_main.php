...
<!--menu-->
			...
			<div id="dashboard"> 
					...
					<div class="viewport">
						<div class="overview">
							<h2>Edit Shopping Guide</h2>
								&nbsp;&nbsp;&nbsp;&nbsp; <a href="shopGuide_aboutUs.php">About Us</a><br><br>
								&nbsp;&nbsp;&nbsp;&nbsp; <a href="shopGuide_Payment.php">Payment & Delivery</a><br><br>
								&nbsp;&nbsp;&nbsp;&nbsp; <a href="shopGuide_Return.php">Return & Exchange</a><br><br>
						</div>
					</div>
			  </div>
		</div> <!-- End Content -->       
