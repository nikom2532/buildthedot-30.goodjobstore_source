...
class Mail extends MY_Controller
{
	...
	function test_send()
	{
		$pi = base_url().'public/emailClass/class.phpmailer.php';
		require_once($pi);

			$mail = new PHPMailer();
			$mail->From = "admin@goodjobstore.com";
			$mail->FromName = "goodjob store";
			$mail->Host = "mail.goodjobstore.com";
			$mail->Mailer = "smtp";


		$mail->AddAddress("chayakorn.e@gmail.com"); // name is optional
