			...
			<div id="withlist"> 
				<div id="scrollbar_order">
					...
					<td>
						...
						<div id="right">Subtotal 
							<?
								if($result->products_Price_sale!=0)
									$exTotal = number_format($result->products_Price_sale*$result->wish_list_Qty);
								else
									$exTotal = number_format($result->products_Price_Buy*$result->wish_list_Qty);
								if(LANG=='EN')
