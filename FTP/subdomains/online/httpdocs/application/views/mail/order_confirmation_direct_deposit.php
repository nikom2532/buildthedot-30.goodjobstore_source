...
<p style="font-size: 12px; color: #999; font-family: Tahoma, Geneva, sans-serif;"> You have chosen to pay by Direct Deposit, please keep your payment evidence that issued by Direct Deposit Bank for recognition until goods has been received. <br />Your order will be shipped out to you upon confirmation of your payment. </p>
    ...
    <tr>
      <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          ...
          <tr>
            <td colspan="3"> </td>
            <td align="right" width="108" style="font-size: 12px;  font-family: Tahoma, Geneva, sans-serif;"><strong>Total <?=(LANG=='TH')?'THB':'USD';?><br />
              </strong></td>
    ...
    <tr>
      <td style="font-size: 12px; color: #999; font-family: Tahoma, Geneva, sans-serif;"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          ...
          <tr>
            <td><p>You have chosen to pay by direct deposit, please deposit the funds to the following account using your order number as the payment reference.</p>
              ...
              <p>Upon receiving of your position, your order will be shipped - usually within 48 hours <br/>If we do not receive payment within 4 business days we will send you a reminder email.<br/> After 7 days and no payment has been received we will attempt to call you before cancelling your order.</p></td>
          </tr>
        </tbody>
      </table><p>&nbsp;</p></td>
    </tr>
