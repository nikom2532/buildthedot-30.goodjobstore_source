...
<body>
<p><img src="http://online.goodjobstore.com/public/images/order_confirmation.jpg" alt="logo" width="804" height="139" />
</p>
<p>&nbsp;</p>
...
<p style="font-size: 12px; color: #999; font-family: Tahoma, Geneva, sans-serif;"> You have chosen to pay by PayPal, please keep your payment evidence that issue by PayPal Bank for recognition until goods has been recieved<br />
Your order will be shipped out to you upon confirmation of your payment. </p>
      ...
      <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          ...
          <tr>
            ...
            <td align="right" width="120" style="font-size: 12px; color: #999; font-family: Tahoma, Geneva, sans-serif;"><?=number_format(cal_range_weight($order->How_ID, $order->Total_Weight))?> ฿<br /></td>
            </tr>
          <tr>
            <td colspan="3"> </td>
            <td align="right" width="108" style="font-size: 12px; color: #999; font-family: Tahoma, Geneva, sans-serif;">Services<br /></td>
            <td align="right" width="120" style="font-size: 12px; color: #999; font-family: Tahoma, Geneva, sans-serif;"><?=number_format(cal_price_option($order->Order_ID))?> ฿<br /></td>
            </tr>
          <tr>
            <td colspan="3"> </td>
            <td align="right" width="108" style="font-size: 12px;  font-family: Tahoma, Geneva, sans-serif;"><strong>Total THB<br />
              </strong></td>
            <td align="right" width="120" style="font-size: 12px;  font-family: Tahoma, Geneva, sans-serif;"><strong><?=number_format($order->Total_Price + cal_range_weight($order->How_ID, $order->Total_Weight) + cal_price_option($order->Order_ID))?> ฿<br />
              </strong></td>
            </tr>
          </tbody>
      </table></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="73%">
  <tbody>
    ...
    <tr>
      ...
      <td align="right" style="font-size: 14px;  font-family: Tahoma, Geneva, sans-serif;"><strong>Est. Delivery Time: 7 - 21 day delivery </strong><br /></td>
    </tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="73%">
  <tbody>
    ...
    <tr>
      <td style="font-size: 14px; font-family: Tahoma, Geneva, sans-serif;"><strong>Payment Method: </strong>direct deposit<strong><br />
      </strong></td>
    </tr>
    <tr>
      <td style="font-size: 12px; color: #999; font-family: Tahoma, Geneva, sans-serif;"><table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td><p>You have choosen to pay by direct deposit, please deposit the funds to the following account using your order number as the payment reference.</p>
              <p style="font-size: 12px; color: #000; font-family: Tahoma, Geneva, sans-serif;">Account Name: บริษัท กู๊ดจ็อบ จำกัด<br />
                Financial Institution: ธนาคารกสิกรไทย<br />
                Company Code: 40319<br />
                Account Number: 748-1-01755-0</p>
              <p style="font-size: 12px; color: #000; font-family: Tahoma, Geneva, sans-serif;">หรือ<br />
              </p>
              <p style="font-size: 12px; color: #000; font-family: Tahoma, Geneva, sans-serif;">Account Name: บริษัท กู๊ดจ็อบ จำกัด<br />
                Financial Institution: ธนาคารกรุงศรีอยุธยา<br />
                Company Code: 40319<br />
                Account Number: 404-0-00935-6</p>
              <p><br />
              </p>
...
<table width="808" cellpadding="0" cellspacing="0">
  <tr>
    <td width="806"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
      <tr>
  ...
  <tr>
    <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          <td valign="top" width="269" style="font-size: 12px; color: #999; font-family: Tahoma, Geneva, sans-serif;"><p>Additional Information<br />
          ...
          <td align="right" valign="top" width="204"><div>
