...
//include('/var/www/vhosts/goodjobstore.com/subdomains/online/httpdocs/dashboard/my/barcode.php');
  ...
  $pdf->Image("http://online.goodjobstore.com/public/barcode/barcode.png",270,780,300,30); 
  /*$line1 = "|010553910162500"; //puwadon
  $line2= $order->Order_ID;//puwadon
  $line3 = $order->Final_Price.'00';  //puwadon
...
$giftwarp='NO';
  ...
  $pdf->Text(400,195,$customer->Cus_ID);
  ...
  $pdf->Text(275,820,'|');
  $pdf->Text(320,820,'010553910162500');
  $pdf->Text(380,820,'00');
  $pdf->Text(430,820,$order->Order_ID);
  $pdf->Text(550,820,$order->Final_Price);
