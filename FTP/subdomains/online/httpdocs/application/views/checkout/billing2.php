...
/*
															if(LANG=='EN')
																echo "$ ".google_finance_convert("THB", "USD", $exRprice);
															else
																echo $exRprice." ฿";
*/
														?>
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: right; padding-right: 50px;">
								<?
									$exSubtotal = number_format($order->Total_Price);
									echo $exSubtotal." ฿";
/*
									if(LANG=='EN')
										echo "$ ".google_finance_convert("THB", "USD", $exSubtotal);
									else
										echo $exSubtotal." ฿";
*/
								?>
						...
						<tr>
							...
							<td style="text-align: right; padding-right: 50px;">
								<?
									$exShipping = number_format(cal_range_weight($order->How_ID, $order->Total_Weight));
									echo $exShipping." ฿";
/*
									if(LANG=='EN')
										echo "$ ".google_finance_convert("THB", "USD", $exShipping);
									else
										echo $exShipping." ฿";
*/
								?>
						...
						<tr>
							...
							<td style="text-align: right; padding-right: 50px;">
								<?
									$exService = number_format(cal_price_option($order->Order_ID));
									echo $exService." ฿";
/*
									if(LANG=='EN')
										echo "$ ".google_finance_convert("THB", "USD", $exService);
									else
										echo $exService." ฿";
*/
								?>
						...
						<tr>
							...
							<td style="text-align: right; padding-right: 50px; font-weight: bold;">
								<h4>
									<?
										$exTotal = number_format($order->Total_Price + cal_range_weight($order->How_ID, $order->Total_Weight) + cal_price_option($order->Order_ID));
										echo $exTotal." ฿";
/*
										if(LANG=='EN')
											echo "$ ".google_finance_convert("THB", "USD", $exTotal);
										else
											echo $exTotal." ฿";
*/
									?>
