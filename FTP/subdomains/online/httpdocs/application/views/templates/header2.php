...
<!--
<?
	function google_finance_convert_header($from_Currency, $to_Currency, $amount) 
	{
...
/*
									if(LANG=='EN')
										echo "$ ".google_finance_convert_header("THB", "USD", $exHPrice);
									else
										echo $exHPrice." ฿";
*/
								?>
...
/*
						if(LANG=='EN')
							echo "$ ".google_finance_convert_header("THB", "USD", $exHTotal);
						else
							echo $exHTotal." ฿";
*/
					?>
