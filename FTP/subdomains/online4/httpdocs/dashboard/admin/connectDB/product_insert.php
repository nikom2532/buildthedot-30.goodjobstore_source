...
//************************ sql Add Product ***************************
	...
	$sqlAddPro = "INSERT INTO products (Product_ID,Product_Code,Property_Name,Pro_Name_En,Pro_Name_Th,Description_En,Description_Th,Size,Price_Buy,Price_sale,Discount_PC,Discount_Num,Short_msg_En,Short_msg_Th,Qty,Sale_min,Sale_max,KeyWord,Weight,Url_En,Url_Th,Discount_Status,Product_Status,attribute_id,Property_ID) 
				VALUES ('".$genProID."','".$proCode."','".$propertyName."','".$proNameEN."','".$proNameTH."','".$descripEN."','".$descripTH."','".$proSize."','".$proPrice."','".$proPriceTotal."','".$proDisPC."','".$proDisNum."','".$proMsgEN."','".$proMsgTH."','".$proQty."','".$proSaleMin."','".$proSaleMax."','".$proKeyWord."','".$proWeight."','".$proUrlEN."','".$proUrlTH."','".$proDisStat."','".$proStatus."','".$proAtt."','".$proPropID."')";
