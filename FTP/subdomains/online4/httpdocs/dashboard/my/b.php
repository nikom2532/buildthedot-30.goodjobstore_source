...
function ImageBarcode($line1,$line2,$lin3)
{
		...
		$bacodeText = $line1 .$crString . $line2.$crString.$line3;  //  Input Value here  ***********
		//echo $bacodeText;
		...
		2 - Background color */
		$barcodeImageName ='image/'. time().rand(1,6).".jpg";
...
$line1 = "|30117690271100";
$line2 = "P000032406122248";
$line3 = "10000";
$barcodeImageName = ImageBarcode($line1,$line2,$line3);
