		...
		for ($i=1;$i<=$Num_Pages;$i++)
			{
				if ($i != $Page)
				{
					echo("<a href=\"JavaScript:viewListSearch('$i','$strKeyword');viewNavSearch('$i','$strKeyword')\">$i</a>");
				} 
				else 
				{
					echo("<a href=\"JavaScript:viewListSearch('$i','$strKeyword');viewNavSearch('$i','$strKeyword')\" class=\"active\">$i</a>");
				}
			}
	?>