	...
	<?
		...
		if($Num_Pages != 1)
		{
			for ($i=1;$i<=$Num_Pages;$i++)
			{
					...
					if ($i != $Page)
					{
						echo("<a href=\"JavaScript:viewList('$i','$strMain_64','$strSub_64','$strSon_64','$strThumb_64','$strMin','$strMax','$strUrl','$language');viewNav('$i','$strMain_64','$strSub_64','$strSon_64','$strThumb_64','$strMin','$strMax','$strUrl')\">$i</a>");
					} 
					else 
					{
						echo("<a href=\"JavaScript:viewList('$i','$strMain_64','$strSub_64','$strSon_64','$strThumb_64','$strMin','$strMax','$strUrl','$language');viewNav('$i','$strMain_64','$strSub_64','$strSon_64','$strThumb_64','$strMin','$strMax','$strUrl')\" class=\"active\">$i</a>");
					}
			 }
		}
	?>