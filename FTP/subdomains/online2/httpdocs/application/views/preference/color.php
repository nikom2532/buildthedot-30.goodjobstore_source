    ...
    <div class="breadLine">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li class="current"><a href="<?=site_url('preference/color')?>">Color</a></li>
            </ul>
        </div> 
    </div>
		<!-- messages -->
		...
		<?=$this->load->view('templates/middle_menu', 'class=main')?>
			<fieldset>
                <div class="widget fluid">
                    <div class="whead"><h6>Add Color</h6>
                    <div class="clear"></div></div>
                    
					<?//=form_open_multipart('preference/create_color_update')?>
					<form id="create_color" class="main" action="<?=base_url('preference/create_color_update')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
						<div class="formRow">
