    ...
    <div class="breadLine">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li class="current"><a href="<?=site_url('admin/profile')?>">Edit Profile</a></li>
            </ul>
        </div> 
    </div>
		...
		<?=$this->load->view('templates/middle_menu', 'class=main')?>
            <fieldset>
                <div class="widget fluid">
                    <div class="whead"><h6>Edit Profile</h6>
                    <div class="clear"></div></div>

					<?//=form_open_multipart('admin/profile_update')?>
					<form id="edit_profile" class="main" action="<?=base_url('admin/profile_update')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    ...
                    <div class="formRow">
                        <div class="grid3"><label>Current Password:<span class="req">*</span></label></div>
                        <div class="grid3"><input type="password" name="cur_pass" id="cur_pass" value=""/></div>
						<div class="grid3"><font color='red'><?=(isset($er_curPass))?$er_curPass:'';?></font></div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
