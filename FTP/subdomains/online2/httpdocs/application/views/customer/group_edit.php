    ...
    <div class="breadLine">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li class="current"><a href="<?=site_url('customer/group/edit/'.set_value('name', ''))?>">Edit Detail</a></li>
            </ul>
        </div> 
    </div>
		...
		<?=$this->load->view('templates/middle_menu', 'class=main')?>
			<fieldset>
				<div class="widget fluid">
					...
					<form id="edit_group" class="main" action="<?=base_url('customer/group_update')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
						...
						<div class="formRow">
							<input type="button" class="buttonS bSea formSubmit" value="CANCEL" onClick="window.location.href='<?=site_url("customer/group/".set_value('name', ''))?>'">
