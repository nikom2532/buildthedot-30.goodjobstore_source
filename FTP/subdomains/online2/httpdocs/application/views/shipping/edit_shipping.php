    ...
    <div class="breadLine">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
				...
				<li class="current"><a href="<?=site_url("shipping/edit/".$shipping_id)?>">Edit <?=get_shipping_name($shipping_id)?></a></li>
            </ul>
        </div> 
    </div>
		<!-- messages -->
		...
		<?=$this->load->view('templates/middle_menu', 'class=main')?>
			<fieldset>
                <div class="widget fluid">
                    <div class="whead"><h6>Edit <?=get_shipping_name($shipping_id)?></h6>
                    <div class="clear"></div></div>
                    
					<?//=form_open_multipart('preference/create_keyword_update')?>
					<form id="edit_shipping" class="main" action="<?=base_url('shipping/edit_shipping_update')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
