$(function() {
	...
	$("#create_admin").validate({
			rules: {
				...
				conf_pass: { required: true, equalTo: "#new_pass", minlength: 6 }
			},
			messages: {
				...
				email: { required: "Please specify email", email: "Correct format is name@domain.com" },
				new_pass: "Password is required at least 6 characters.",
				conf_pass: "Password is not match.",
	...
	$("#edit_profile").validate({
			rules: {
				...
				phone: "required",
				email: { required: true, email: true },
				new_pass: { required: false, minlength: 6 },
				conf_pass: { required: false, equalTo: "#new_pass", minlength: 6 },
				cur_pass: "required"
			},
			messages: {
				firstname: "First name is required.",
				...
				new_pass: "Password is required at least 6 characters.",
				conf_pass: "Password is not match.",
				cur_pass: "Current password is required."
				}
	});
	...
	$("#edit_cus").validate({
			...
			messages: {
				...
				b_firstname: "First name is required.",
				b_lastname: "Last name is required.",
				b_address: "Address is required.",
				b_city_id: "Please choose city.",
				b_postcode: "Postcode is required.",
				b_country_id: "Please choose country.",
				b_phone: "Phone number is required.",
				
				s_firstname: "First name is required.",
				s_lastname: "Last name is required.",
				s_address: "Address is required.",
				s_city_id: "Please choose city.",
				s_postcode: "Postcode is required.",
				s_country_id: "Please choose country.",
				s_phone: "Phone number is required."
	...
	$("#create_product").validate({
			...
			messages: {
				...
				name: "Name is required",
				prop_id: "Property is required",
				color_id: "Color is required",
	...
	$("#create_shipping_range").validate({
		    rules: {
				weight_min: "required",
				weight_max: "required",
				price: "required"				},
	...
	$("#create_product_group").validate({
			rules:{
				progroup_id: "required",
				name: "required",
				url: "required"
			},
			messages:{
				progroup_id: "ID is required.",
				name: "Name is required.",
				url: "Url is required."
			}
	});
	...
	$('#dyn .tOptions1').click(function () {
		$('#dyn .tablePars').slideToggle(200);
	});	
	
	$('#dyn2 .tOptions1').click(function () {
		$('#dyn2 .tablePars').slideToggle(200);
	});	
	
	
	$('.tOptions1').click(function () {
		$(this).toggleClass("act");
	});
