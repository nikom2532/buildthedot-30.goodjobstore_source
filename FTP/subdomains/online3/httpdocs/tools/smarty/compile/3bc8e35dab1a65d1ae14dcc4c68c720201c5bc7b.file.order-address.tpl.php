<?php /* Smarty version Smarty-3.0.7, created on 2012-04-23 23:09:04
         compiled from "/var/www/vhosts/goodjobstore.com/subdomains/online/httpdocs/themes/goodjob/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21127188074f957ea085bb70-19098739%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3bc8e35dab1a65d1ae14dcc4c68c720201c5bc7b' => 
    array (
      0 => '/var/www/vhosts/goodjobstore.com/subdomains/online/httpdocs/themes/goodjob/order-address.tpl',
      1 => 1335097972,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21127188074f957ea085bb70-19098739',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_function_counter')) include '/var/www/vhosts/goodjobstore.com/subdomains/online/httpdocs/tools/smarty/plugins/function.counter.php';
...
</h1><?php }else{ ?><h1>1. <?php echo smartyTranslate(array('s'=>'Addresses'),$_smarty_tpl);?>
</h1><?php }?>

<?php if (!$_smarty_tpl->getVariable('opc')->value){?>
<?php $_smarty_tpl->tpl_vars['current_step'] = new Smarty_variable('billing', null, null);?>
...
<?php }?>
	<div class="addresses" >
		<br><br><br>
		<p  class="address_delivery select" type="hidden">
...
" class="button_large"><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
		...
		<div class="clear"></div>
        <br />
		<ul class="address alternate_item <?php if ($_smarty_tpl->getVariable('cart')->value->isVirtualCart()){?>full_width<?php }?>" id="address_invoice"><li><?php echo smartyTranslate(array('s'=>"ddd"),$_smarty_tpl);?>
</li>
		</ul>
...
" class="button_large"><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
		...
		<div id="ordermsg">
			...
			<p class="textarea"><textarea cols="100" rows="3" name="message"><?php if (isset($_smarty_tpl->getVariable('oldMessage',null,true,false)->value)){?><?php echo $_smarty_tpl->getVariable('oldMessage')->value;?>
<?php }?></textarea></p>
		</div>
		<?php }?>
	</div>
...
" />
 ...
 &raquo;" class="mybutton_large" style="margin-left: 10px; height: 22px; border: none; cursor: pointer; padding-top: -1PX;" />
...
" class="mybutton_large">&laquo; <?php echo smartyTranslate(array('s'=>'PREVIOUS'),$_smarty_tpl);?>
</a>
	</p>
</form>
<?php }else{ ?>
