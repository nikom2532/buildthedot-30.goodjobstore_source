<?php /* Smarty version Smarty-3.0.7, created on 2012-06-28 20:45:30
         compiled from "/var/www/vhosts/goodjobstore.com/subdomains/online3/httpdocs/themes/goodjob/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7576628074fec5ffa2135b8-40046266%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a2c990b47ef4745f9a0d575b85a2ba9a8fae7a12' => 
    array (
      0 => '/var/www/vhosts/goodjobstore.com/subdomains/online3/httpdocs/themes/goodjob/authentication.tpl',
      1 => 1334915894,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7576628074fec5ffa2135b8-40046266',
  'function' => 
  array (
  ),
...
" method="post" id="login_form" class="std">
			...
			<p class="text2"><b><?php echo smartyTranslate(array('s'=>'Sign in'),$_smarty_tpl);?>
</b></p>
			<p class="text3"><?php echo smartyTranslate(array('s'=>'Please sign in to view or update your Shopping Bag and Wishlist'),$_smarty_tpl);?>
.</p>
			<p class="text1">
				<label for="email"><br><b><?php echo smartyTranslate(array('s'=>'E-mail'),$_smarty_tpl);?>
</b></br></label>
...
<?php }?>" class="account_input" /></span>
			...
			<p class="text1">
				<label for="passwd"><b><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
</b></label>
...
" /><?php }?>
				<br><INPUT TYPE="submit" id="SubmitLogin" name="SubmitLogin" class="mybutton" value="<?php echo smartyTranslate(array('s'=>'SIGN IN'),$_smarty_tpl);?>
" />
			</p>
...
" method="post" id="create-account_form" class="std">
			...
			<p class="text2"><b><?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
</b></p>
			<p class="text3"><?php echo smartyTranslate(array('s'=>'Register here to create your personal Shopping Bag and Wishlist'),$_smarty_tpl);?>
.</p>
			<p class="text1">
				<label for="email_create"><b><br><?php echo smartyTranslate(array('s'=>'E-mail'),$_smarty_tpl);?>
</br></b></label>
...
<?php }?>" class="account_input" /></span>
			...
			<?php if (isset($_smarty_tpl->getVariable('back',null,true,false)->value)){?><input type="hidden" class="hidden" name="back" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('back')->value,'htmlall','UTF-8');?>
" /><?php }?>
				<br><input type="submit" id="SubmitCreate" name="SubmitCreate" class="button_large1" value="<?php echo smartyTranslate(array('s'=>'Registers Now'),$_smarty_tpl);?>
" />
