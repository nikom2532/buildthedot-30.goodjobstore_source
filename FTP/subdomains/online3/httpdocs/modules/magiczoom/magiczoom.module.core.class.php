...
if(!defined('MagicZoomModuleCoreClassLoaded')) {
    ...
    class MagicZoomModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null) {
            ...
            $headers = array();
            $headers[] = '<!-- Magic Zoom Prestashop module version v5.1.9 [v1.1.15:v4.0.6] -->';
