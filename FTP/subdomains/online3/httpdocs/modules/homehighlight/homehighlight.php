...
class HomeHighlight extends Module
{
	/* @var boolean error */
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Banner highlight on the homepage');
	...
	public function hookHome($params)
	{
		...
		$objBanner = new BannerHighlight();
		$banners = $objBanner->get_banner((int)($params['cookie']->id_lang));
		
		$smarty->assign(array(
		'banners' => $banners));
				
		return $this->display(__FILE__, 'homehighlight.tpl');
	}
