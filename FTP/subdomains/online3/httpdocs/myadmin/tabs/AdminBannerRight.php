...
class AdminBannerRight extends AdminTab
{ 
   
  public function __construct() 
  {
		$this->table = 'banner_right'; 
		$this->className = 'BannerRight';
		$this->lang = true;
		$this->edit = true;
		$this->delete = true;
		
		$this->fieldsDisplay = array(
		  'id_banner_right' => array( 'title' => $this->l( 'ID' ),'align' => 'center', 'width' => 25 ),
		  'image' => array('title' => $this->l('Photo'), 'align' => 'center', 'image' => 'module_br', 'width' => 50, 'orderby' => false, 'filter' => false, 'search' => false),
		  'title' => array('title' => $this->l( 'Title' ), 'width' => 300 ),
		  'active' => array('title' => $this->l('Enabled'), 'width' => 25, 'align' => 'center', 'active' => 'status', 'type' => 'bool', 'orderby' => false)
		 );
		
		$this->fieldImageSettings = array('name' => 'image', 'dir' => 'module_br');
  ...
  public function displayForm()
  {
    ...
    echo '
      <form action="' . $currentIndex . '&submitAdd' .  $this->table . '=1&token=' . $this->token . '" method="post" class="width3" enctype="multipart/form-data">
        ...
        <fieldset><legend><img src="../img/admin/profiles.png" />' . $this->l( 'Right Banner' ) . '</legend>
    ...
    echo '
		...
		echo '
					...
					<p>'.$this->l('Upload banner from your computer').' (.gif, .jpg, .jpeg '.$this->l('or').' .png : 600x450 px)</p>
				</div>';
