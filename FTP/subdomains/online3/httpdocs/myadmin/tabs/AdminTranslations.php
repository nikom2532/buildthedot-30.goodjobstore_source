...
*  @version  Release: $Revision: 12468 $
...
<body>
	...
	public function display()
	{
		...
		else
		{
			...
			$this->l('Here you can modify translations for all text input into Shop.').'<br />'.
			...
			/* begin1 */
			//echo 'id='.$cookie->profile;
			if($cookie->profile == 1) // for developer only
			{//$cookie->profile
				echo '<br /><br /><h2>'.$this->l('Translation exchange').'</h2>';
