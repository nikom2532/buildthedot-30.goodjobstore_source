...
{if !$opc}
	<p class="cart_navigation submit">
        ...
        <input type="submit" name="processCarrier" value="{l s='NEXT'} &raquo;" class="mybutton_large" style="margin-left: 10px; height: 22px; border: none; cursor: pointer; padding-top: -1PX;" />
		<a href="{$link->getPageLink('order.php', true)}{if !$is_guest}?step=1{if $back}&back={$back}{/if}{/if}" title="{l s='Previous'}" class="mybutton_large">&laquo; {l s='PREVIOUS'}</a>
