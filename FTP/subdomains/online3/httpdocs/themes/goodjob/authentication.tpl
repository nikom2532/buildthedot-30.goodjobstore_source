...
<form action="{$link->getPageLink('authentication.php', true)}" method="post" id="login_form" class="std">
			...
			<p class="text2"><b>{l s='Sign in'}</b></p>
			<p class="text3">{l s='Please sign in to view or update your Shopping Bag and Wishlist'}.</p>
			<p class="text1">
				<label for="email"><br><b>{l s='E-mail'}</b></br></label>
			...
			<p class="text1">
				<label for="passwd"><b>{l s='Password'}</b></label>
			...
			<p class="submit">
				...
				<br><INPUT TYPE="submit" id="SubmitLogin" name="SubmitLogin" class="mybutton" value="{l s='SIGN IN'}" />
			</p>
...
<form action="{$link->getPageLink('authentication.php', true)}" method="post" id="create-account_form" class="std">
			...
			<p class="text2"><b>{l s='Create an account'}</b></p>
			<p class="text3">{l s='Register here to create your personal Shopping Bag and Wishlist'}.</p>
			<p class="text1">
				<label for="email_create"><b><br>{l s='E-mail'}</br></b></label>
			...
			<p class="submit">
			{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
				<br><input type="submit" id="SubmitCreate" name="SubmitCreate" class="button_large1" value="{l s='Registers Now'}" />
